...
function show()  {
		...
		//get last 2 characters from the id name (eg accordion_li10 to get the number 10), and convert it to an integer by multiplying by 1
		...
		//populate the arrays, based on the element number, and then display them
	 	...
	 	//display the hidded elements by setting the display to 'block'
